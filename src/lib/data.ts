...
export const courses: Course[] = [
  {
    ...
    description: "Learn the fundamentals of web development including HTML, CSS, and JavaScript from scratch.",
    duration: "3.5 hours",
    lessons: 24,
  ...
  },
  {
    ...
    description: "Master descriptive statistics concepts including mean, median, mode, standard deviation, and data visualization.",
    duration: "3 hours",
    lessons: 20,
  ...
  },
  {
    ...
    description: "Learn social media marketing, SEO, email marketing, and analytics to grow any brand online.",
    duration: "4 hours",
    lessons: 28,
    category: "Marketing",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Understand the fundamentals of computing, algorithms, and problem-solving techniques.",
    duration: "4 hours",
    lessons: 30,
    category: "Development",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Develop effective communication skills for the workplace including presentations, emails, and negotiations.",
    duration: "3.5 hours",
    lessons: 25,
    category: "Business",
    level: "Beginner",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?w=100&h=100&fit=crop",
    description: "Understand personal finance, budgeting, savings, and the basics of stock market investing.",
    duration: "4 hours",
    lessons: 26,
    category: "Business",
    level: "Beginner",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=100&h=100&fit=crop",
    description: "Explore fiction, poetry, and non-fiction writing techniques to express your ideas with clarity and creativity.",
    duration: "3 hours",
    lessons: 20,
    category: "Arts",
    level: "Beginner",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=100&h=100&fit=crop",
    description: "Learn about computer components, assembly, troubleshooting, and maintenance from the ground up.",
    duration: "3.5 hours",
    lessons: 22,
    category: "Development",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Overcome stage fright and learn to deliver impactful speeches and presentations with confidence.",
    duration: "3 hours",
    lessons: 16,
    category: "Business",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Explore the fundamentals of human behavior, cognition, emotions, and mental processes.",
    duration: "4 hours",
    lessons: 28,
    category: "Arts",
    level: "Beginner",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=100&h=100&fit=crop",
    description: "Create professional graphics, social media posts, and branding materials using Canva.",
    duration: "3 hours",
    lessons: 18,
    category: "Design",
    level: "Beginner",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&h=100&fit=crop",
    description: "Learn planning, scheduling, risk management, and team leadership for successful project delivery.",
    duration: "3.5 hours",
    lessons: 24,
    category: "Business",
    level: "Intermediate",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop",
    description: "Understand Newton's laws, motion, energy, and the fundamental principles of classical mechanics.",
    duration: "4 hours",
    lessons: 30,
    category: "Data Science",
    level: "Intermediate",
  ...
  },
  {
    ...
    instructorAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop",
    description: "Hands-on physics experiments covering optics, electricity, and measurement techniques.",
    duration: "3 hours",
    lessons: 15,
    category: "Data Science",
    level: "Intermediate",
