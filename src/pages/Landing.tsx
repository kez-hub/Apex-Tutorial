...
export default function Landing() {
  ...
  const stats = [
    { icon: BookOpen, value: "60+", label: "Videos" },
  ...
  const features = [
    ...
    "Get certificates upon video completion",
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-8 animate-fade-in">
              ...
              <h1 className="font-heading text-4xl font-bold leading-tight text-foreground md:text-5xl lg:text-6xl">
                Unlock Your <span className="text-primary">Learning</span>
                <span className="block mt-2">Potential</span>
              </h1>

              <p className="max-w-lg text-lg text-muted-foreground">
                Join thousands of learners mastering new skills with our
                expert-led videos. Start your journey today and transform your
                future.
              </p>
            ...
            <div className="relative hidden lg:block animate-slide-in-right">
              ...
              {/* Floating cards */}
              <div
                className="absolute -left-8 bottom-8 rounded-xl bg-card p-4 shadow-elevated animate-fade-in"
              ...
              <div
                className="absolute -right-8 top-8 rounded-xl bg-card p-4 shadow-elevated animate-fade-in"
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              Explore our most popular videos taught by industry experts and
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-primary-foreground/80">
            Join our community of learners and get access to hundreds of videos
            taught by experts.
          </p>
          <Button
            size="xl"
