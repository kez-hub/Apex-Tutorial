      ...
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Quickly find answers instantly without having to contact our support
            team.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <details
              key={idx}
              className="group bg-card border border-border/50 rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden"
            >
